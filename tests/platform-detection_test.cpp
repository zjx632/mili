...
TEST(PlatformDetectionTest, Compiler)
{
    ...
    ASSERT_EQ(MILI_COMPILER_CLANG,   4);
    ASSERT_EQ(MILI_COMPILER_TICCS,   5);
    ASSERT_EQ(MILI_COMPILER_UNKNOWN, 6);

    ASSERT_TRUE((MILI_COMPILER == MILI_COMPILER_VS) \
                ^ (MILI_COMPILER == MILI_COMPILER_GCC)   \
                ^ (MILI_COMPILER == MILI_COMPILER_ICC)   \
                ^ (MILI_COMPILER == MILI_COMPILER_CLANG) \
                ^ (MILI_COMPILER == MILI_COMPILER_TICCS) \
